...
export default function Navbar({admin}) {
  ...
  return (
    <header className="">
      <nav className="bg-gray-900 mx-auto flex max-w-8xl items-center justify-between p-6 lg:px-8" aria-label="Global">
      <div className="flex lg:flex-1 items-center">
  <a href="#" className="flex items-center -m-1.5 p-1.5">
    <div className="flex items-center">
      <span className="ml-3 text-l font-ubuntu font-bold text-white">EQUITYSTREET</span>
