...
<br></br><br></br>
                ...
                <p className=" font-regular font-ubuntu text-justify text-l text-orange-400">mahesh.thangaraju@gmail.com</p>
                <p className=" font-regular font-ubuntu text-justify text-l text-orange-400">+91 9629484649</p>
            </div>
